// HPR core v3 - explicit surface meshing before extrusion
core_height = 1.60;
hp_r        = 0.00450;
fp_r        = 0.00350;
hp_ring_r   = 0.0265;
...
// Extrude with layers for stable 3D mesh
n_layers = 14;
out_g[]  = Extrude {0, 0, core_height} {
    Surface{100}; Layers{n_layers}; Recombine;
};
out_hp[] = Extrude {0, 0, core_height} {
    Surface{10};  Layers{n_layers}; Recombine;
};
out_f1[] = Extrude {0, 0, core_height} {
    Surface{20};  Layers{n_layers}; Recombine;
};
out_f2[] = Extrude {0, 0, core_height} {
    Surface{30};  Layers{n_layers}; Recombine;
};
