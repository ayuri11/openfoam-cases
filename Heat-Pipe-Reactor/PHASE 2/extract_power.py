...
P_total_W   = 15e6             # W — target thermal power
...
print(f"\nVerification: integrated total power = {total_power_check/1e6:.4f} MWth (should be ~15 MWth)")
...
fv_lines.append("// Units: W/m³ normalized to 15 MWth total power")
fv_lines.append("")
