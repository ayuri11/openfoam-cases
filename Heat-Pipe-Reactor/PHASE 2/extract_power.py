...
# =============================================================================
# design target from methodology: ~15 MWth
P_total_W   = 15e6  # W — reference normalization power
                    # NOTE: actual design power revised to 2.5 MWth in Phase 3
                    # normalization reference kept at 15 MWth for consistency
                    # Phase 3 rescales independently using P_total = 2.5e6
...
# verify total power integrates to ~15 MWth
...
summary = {
    ...
    'P_total_MWth_design': 2.5,
    'rescale_factor': 2.5 / 15.0,
...
fv_lines.append("// Units: W/m³ normalized to 15 MWth reference power")
fv_lines.append("// Actual design power = 2.5 MWth — rescale by factor 2.5/15 = 0.1667 for OpenFOAM")
fv_lines.append("")
